        ...
        <div className='w-full flex justify-between items-center max-w-7x1 mx-auto'>
          <Link
            ...
            <p className='text-white text-[18px] font-bold cursor-pointer flex'>
              Stefan&nbsp;
              <span className='sm:block hidden'>| manalax.dev</span>
            </p>
          </Link>
          ...
          <div className='sm:hidden flex flex-1 justify-end items-centre'>
            ...
            <div className={`${!toggle ? 'hidden' : 'flex' } p-6 black-gradient absolute top-20 right-0 mx-4 my-2 minw-w-[140px] z-10 rounded-xl`}>
